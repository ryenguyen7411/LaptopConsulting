...
namespace ontology_manager
{
    namespace Pc
    {
        ...
        public class Object
        {
            ...
            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasDescription")]
            public IList<HasDescription> HasDescription { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasImage")]
            public IList<HasImage> HasImage { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasLink")]
            public IList<HasLink> HasLink { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasName")]
            public IList<HasName> HasName { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasPrice")]
            public IList<HasPrice> HasPrice { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasCase")]
            public IList<HasCase> HasCase { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasCpu")]
            public IList<HasCpu> HasCpu { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasGpu")]
            public IList<HasGpu> HasGpu { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasHdd")]
            public IList<HasHdd> HasHdd { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasHsf")]
            public IList<HasHsf> HasHsf { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasMobo")]
            public IList<HasMobo> HasMobo { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasPsu")]
            public IList<HasPsu> HasPsu { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasRam")]
            public IList<HasRam> HasRam { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasSsd")]
            public IList<HasSsd> HasSsd { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasTier")]
            public IList<HasTier> HasTier { get; set; }

            [JsonProperty("http://uit.edu.vn/ontologies/laptop#hasTotal")]
            public IList<HasTotal> HasTotal { get; set; }
